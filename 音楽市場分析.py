...
for l in range(0,10):
    Total.append(df_Segments.at[2012+l,'TotalPhysical']+df_Segments.at[2012+l,'Streaming']+df_Segments.at[2012+l,'Downloads'])
...
for l in range(0,9):
    ...
    if df_Segments.at[2013+l,'Downloads']!=0:
...
#csv形式で出力
df_Segments.to_csv(f'/Users/katuy/Desktop/data/Japan_Revenue.csv',encoding="shift-jis")
