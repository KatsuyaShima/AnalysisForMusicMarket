...
df_5guys.to_csv(f'/Users/katuy/Desktop/ユニバデータ/Global_Revenue.csv',encoding="shift-jis")
df_flow.to_csv(f'/Users/katuy/Desktop/ユニバデータ/Global_Flow.csv',encoding="shift-jis")
